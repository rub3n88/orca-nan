...
con `nohup`, porque se está matando a sí mismo— y solo lo deja vivo si algo falló o quedó un informe
por revisar. Desde ese worktree `git checkout main` no funciona (main está en el worktree principal):
